                                    ...
                                    For hands = 1 To NSplitCalcs
                                        ...
                                        If (BBO Or OBBO Or AOBBO) And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then 'things get really ugly!!
                                            ...
                                            If upcard = 1 And Not CheckAce Then
                                                ...
                                                If CardProb(10, 0) > 0 Then
                                                    CurrentShoe.Deal(10)
                                                    SplitProbs(paircard, upcard).PxResCards(SplitCalcHands(hands), card) = CardProb(card, 0)
                                                    CurrentShoe.Undeal(10)
                                                Else
                                                    SplitProbs(paircard, upcard).PxResCards(SplitCalcHands(hands), card) = 0
                                                End If
                                            ElseIf upcard = 10 And Not CheckTen Then
                                                CurrentShoe.Deal(card)
                                    ...
                                    For hands = 0 To NSplitHands
                                        If NPxHands(hands).NN > 0 Then
                                            ...
                                            If (BBO Or OBBO Or AOBBO) And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then
                                                SplitProbs(paircard, upcard).PBJ(hands, card) = ConditionalValue(SplitProbs(paircard, upcard).PBJ(NPxHands(hands).UCH, card), SplitProbs(paircard, upcard).PBJ(NPxHands(hands).CH, card), SplitProbs(paircard, upcard).PxCards(NPxHands(hands).UCH, paircard))
...
#Region " General Split Methods "
    ...
    Private Sub ComputeSplitEV(ByRef cStrat As BJCAStrategyClass, ByVal paircard As Integer, ByVal upcard As Integer)
                                ...
                                For i = 1 To 10 'Deal double card
                                    ...
                                    Else
                                        ...
                                        If PlayerHands(index).Hand.Soft And (PlayerHands(newIndex).Hand.Cards(1) = 1) And (DSoftAllHard Or (DSoft19Hard And PlayerHands(index).Hand.Total = 19)) Then
                                            ...
                                            CurrentShoe.Deal(upcard)
                                            If (BBO Or OBBO Or AOBBO) And CurrentPHand.Total - 10 = 21 And P21AutoWin And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then
                                        ...
                                        ElseIf Not (RDAPS Or DDRPS) Then
                                            ...
                                            End If
                                            If (BBO Or OBBO Or AOBBO) And CurrentPHand.Total = 21 And P21AutoWin And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then
                                                'pRes for DAS conditioned on dealer actually having BJ
                                                If upcard = 1 And Not CheckAce And CardProb(10, 0) > 0 Then
                                                    UndealPCard(i)
                                                    CurrentShoe.Deal(10)
                            ...
                            Case BJCAGlobalsClass.Strat.H
                                ...
                                If (BBO Or OBBO Or AOBBO) And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then
                                    ...
                                    If EV = 0 Then
                                        ...
                                        cStrat.SplitStateEVs(paircard, upcard).OBBOCards(SplitCalcHands(hands), card) = 0
                                    Else
                                        cStrat.SplitStateEVs(paircard, upcard).BBOCards(SplitCalcHands(hands), card) = newEVs.DealerProbs(upcard, 0)
                                        cStrat.SplitStateEVs(paircard, upcard).OBBOCards(SplitCalcHands(hands), card) = newEVs.DealerProbs(upcard, 1)
                                    End If
                                End If
                            Case BJCAGlobalsClass.Strat.R
            ...
            If (BBO Or OBBO Or AOBBO) And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then
                ...
                If NPxHands(hands).NN = 0 Then
                    For card = 1 To 10
                        ...
                        cStrat.SplitStateEVs(paircard, upcard).PResx(hands) += cStrat.SplitStateEVs(paircard, upcard).PResCards(hands, card) * SplitProbs(paircard, upcard).PxCards(hands, card)
                    ...
                    Next card
                    cStrat.SplitStateEVs(paircard, upcard).PResN(hands) = ConditionalValue(cStrat.SplitStateEVs(paircard, upcard).PResx(hands), cStrat.SplitStateEVs(paircard, upcard).PResCards(hands, paircard), SplitProbs(paircard, upcard).PxCards(hands, paircard))
                ...
                Else
                    ...
                    cStrat.SplitStateEVs(paircard, upcard).PResx(hands) = ConditionalValue(cStrat.SplitStateEVs(paircard, upcard).PResx(NPxHands(hands).UCH), cStrat.SplitStateEVs(paircard, upcard).PResx(NPxHands(hands).CH), SplitProbs(paircard, upcard).PxCards(NPxHands(hands).UCH, paircard))
                    cStrat.SplitStateEVs(paircard, upcard).PResN(hands) = ConditionalValue(cStrat.SplitStateEVs(paircard, upcard).PResN(NPxHands(hands).UCH), cStrat.SplitStateEVs(paircard, upcard).PResN(NPxHands(hands).CH), SplitProbs(paircard, upcard).PxCards(hands, paircard))
        ...
        If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
            EV = 2 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.Full)
            EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.Full) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.Full))
        ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
            EV = cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.Full)
            EV = EV + cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.Full)
        ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
            EV = 2 * cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.Full)
        Else
        ...
        If SPL > 1 Then
            ...
            'EV(N) + EV(N-N)
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.Full) + cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.N)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.Full) * cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.N))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.Full)
                EV = EV + cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.N)
            ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.Full) + cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.N)
            Else
            ...
            '3*EV(x-P)
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = 3 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.P)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.P) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.P) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.P))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.P)
                EV = EV + 2 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.P)
            ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = 3 * cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.P)
            Else
            ...
            'EV(N) + 2*EV(x-PN)
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.Full) + 2 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PN)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.Full) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PN))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.Full)
                EV = EV + 2 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PN)
            ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.Full) + 2 * cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.PN)
            Else
        ...
        If SPL > 2 Then
            ...
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.P)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PN)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PNN)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.P) * cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.PN) * cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.PNN))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.P)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PN)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PNN)
            ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.P)
                EV += cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.PN)
                EV += cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.PNN)
            Else
            ...
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.Full)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PN)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PNN)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.Full) * cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.PN) * cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.PNN))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.Full)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PN)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PNN)
            ...
            '4*EV(x-PP)
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = 4 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PP)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PP) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PP) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PP) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PP))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.PP)
                EV = EV + 3 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PP)
            ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = 4 * cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.PP)
            Else
            ...
            'EV(N-P) + 3*EV(x-PPN)
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.P) + 3 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PPN)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.P) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPN))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.P)
                EV = EV + 3 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PPN)
            ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.P) + 3 * cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.PPN)
            Else
            ...
            'EV(N) + 3*EV(x-PPN)
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.Full) + 3 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PPN)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.Full) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPN))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.Full)
                EV = EV + 3 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PPN)
            ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.Full) + 3 * cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.PPN)
            Else
                EV = cStrat.SplitStateEVs(paircard, upcard).EVN(BJCAGlobalsClass.Hands.PP) + 3 * cStrat.SplitStateEVs(paircard, upcard).EVx(BJCAGlobalsClass.Hands.PPN)
            ...
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.P)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PN)
                EV += 2 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PPNN)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.P) * cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.PN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPNN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPNN))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.P)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PN)
                EV += 2 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PPNN)
            ElseIf (AOBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.P)
                EV += cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.PN)
                EV += 2 * cStrat.SplitStateEVs(paircard, upcard).OBBOx(BJCAGlobalsClass.Hands.PPNN)
            Else
            ...
            If (BBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                ...
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PN)
                EV += 2 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PPNN)
                EV = EV - bjadjprob * (1 - cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.Full) * cStrat.SplitStateEVs(paircard, upcard).PResN(BJCAGlobalsClass.Hands.PN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPNN) * cStrat.SplitStateEVs(paircard, upcard).PResx(BJCAGlobalsClass.Hands.PPNN))
            ElseIf (OBBO And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen))) Then
                EV = cStrat.SplitStateEVs(paircard, upcard).OBBON(BJCAGlobalsClass.Hands.Full)
                EV += cStrat.SplitStateEVs(paircard, upcard).BBON(BJCAGlobalsClass.Hands.PN)
                EV += 2 * cStrat.SplitStateEVs(paircard, upcard).BBOx(BJCAGlobalsClass.Hands.PPNN)
    ...
    Private Function SplitPlayerHit(ByRef cStrat As BJCAStrategyClass, ByVal paircard As Integer, ByVal upcard As Integer, ByVal hands As Integer, ByVal oldindex As Integer, ByVal basecard As Integer, ByVal NetpResProb As Double) As BJCAHandEVsClass
        Dim card As Integer
        Dim i As Integer
        Dim EV As Double
        Dim BBOEV As Double
                ...
                Else    'Not busted
                    ...
                    Select Case strat
                        ...
                        Case BJCAGlobalsClass.Strat.D   'Double
                            ...
                            push += prob * 2 * dPush
                            If (BBO Or OBBO Or AOBBO) And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then
                                cStrat.SplitStateEVs(paircard, upcard).PResCards(hands, basecard) += dRes
                                'ENHC = (1-p(BJ))*(EV|no dBJ) + p(BJ)*((1-sum(p(Res))*(-2) + sum(p(Res)*EV(Res|dBJ))
                                'Doubled
                                'Note that pRes = 1 or 0 and BBO = ENHC when resolved
                                'BBO = (1-p(BJ))*(EV|no dBJ) + p(BJ)*((1-sum(p(Res))*(0) + sum(p(Res)*EV(Res|dBJ))
                        ...
                        Case BJCAGlobalsClass.Strat.H  'Hit
                            newEVs.Empty()
                            newEVs = SplitPlayerHit(cStrat, paircard, upcard, hands, index, basecard, newNetpResProb)
                            ...
                            push += prob * tempPush
                            If (BBO Or OBBO Or AOBBO) And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then
                                BBOEV += prob * newEVs.DealerProbs(upcard, 0)
                                OBBOEV += prob * newEVs.DealerProbs(upcard, 1)
                            End If
                        Case BJCAGlobalsClass.Strat.R
                            newEVs = ComputeSurrenderHand(CurrentShoe.Hand, cStrat.HandEVs(index).RPostallowed(upcard), upcard)
        ...
        If (BBO Or OBBO Or AOBBO) And ((upcard = 1 And Not CheckAce) Or (upcard = 10 And Not CheckTen)) Then
            'Hold BBO and OBBO values in Dealerprobs
            newEVs.DealerProbs(upcard, 0) = BBOEV
            newEVs.DealerProbs(upcard, 1) = OBBOEV
        End If
