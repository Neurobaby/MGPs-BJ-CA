...
<Serializable()> Public Class BJCASplitProbsClass
    ...
    Public PBxCards(10, 10) As Double      'Shoe state, card     Probability of receiving an x given dealer BJ
    ...
    Public PBCBJ(10, 10) As Double          'Shoe state, card     Probability of getting blackjack - needed for paircard
    Public PBCxCards(10, 10) As Double      'Shoe state, card     Conditional probability of receiving an x
...
<Serializable()> Public Class BJCASplitStateStrategyClass
    ...
    'Thesed are only used in OBBO for determining the Bust Probabilities give a dealer BJ
    Public PBx(10) As Double               'Shoe state           Overall Probability of Busting for an x
    Public PBN(10) As Double               'Shoe state           Overall Probability of Busting for an N
    Public PBCards(10, 10) As Double       'Shoe State, card     Probability of Busting given dealer BJ

    'These are used in OBBO to store the Conditional EV's given that the dealer doesn't have BJ
    '    These are the same as the usual EV's when not using OBBO or ENHC
    Public PBCEVx(10) As Double             'Shoe state           Overall CEV for an x
    Public PBCEVN(10) As Double             'Shoe state           Overall CEV for an N
    Public PBCEVCards(10, 10) As Double     'Shoe state, card     Conditional EV of the individual 2-card hand
    ...
    Public Sub Empty()
        ...
        For hands = 0 To 10
            ...
            For card = 0 To 10
                ...
                PBCards(hands, card) = 0
                PBCEVCards(hands, card) = 0
